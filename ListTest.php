...
class ConsListTest extends PHPUnit_Framework_TestCase {
    ...
    public function testAssocArrayToLinkedList() {
        //
        $as = array();
        $xs = AList::_empti();
        ...
        $this->assertEquals($cas, $xs);
        //
        $as = array(1 => "one", 2 => "two", 3 => "three");
        $xs = AList::_empti()->cons(new Pair(3, "three"))->cons(new Pair(2, "two"))->cons(new Pair(1, "one"));
        $cas = AList::assocArrayToLinkedListOfPairs($as);
        $this->assertEquals($cas, $xs);
    }
    ...
    public function testLinkedListOfPairsToAssocArray() {
        //
        $xs = AList::_empti();
        $cxs = AList::linkedListOfPairsToAssocArray($xs);
        $a = array();
        $this->assertEquals($cxs, $a);
        //
        $xs = AList::_empti()->cons(new Pair(3, "three"))->cons(new Pair(2, "two"))->cons(new Pair(1, "one"));
